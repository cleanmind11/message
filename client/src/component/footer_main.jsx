...
const Footer_main = () => {
    ...
    const socialmediaList = icon.map((item, index) => <SocialMedia info={item} key={index} />);
    return(
        <>
        <div className="footer-main">
            <div className="up-footer-main">
                <div className="display-flex">
                    <div className="content-up-footer-main">
                        <div className="fs-36 title-content-up-footer-main">
                        ...
                        <div className="email-content-up-footer-main">
                            <input type="text" className="fs-18 email-footer" placeholder="Type your email here"></input>
            ...
            <div className="down-footer-main">
                <div className="main-down-footer-main">
                    ...
                    <div className="right-main-down-footer-main">
